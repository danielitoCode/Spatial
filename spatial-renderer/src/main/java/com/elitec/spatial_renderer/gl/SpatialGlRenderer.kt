...
class SpatialGlRenderer : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        applyClearColor(SURFACE_WITHOUT_NODES_CLEAR_COLOR)
    ...
    override fun onDrawFrame(gl: GL10?) {
        applyClearColor(
            when {
                nodes.isEmpty() -> SURFACE_WITHOUT_NODES_CLEAR_COLOR
                programId == 0 -> MESH_OR_BUFFER_ERROR_CLEAR_COLOR
                else -> PROGRAM_READY_WITH_NODES_CLEAR_COLOR
            },
        )
    ...
    private fun applyClearColor(color: ClearColor) {
    ...
    private companion object {
        ...
        private val SURFACE_WITHOUT_NODES_CLEAR_COLOR = ClearColor(0.18f, 0.02f, 0.02f)
        private val PROGRAM_READY_WITH_NODES_CLEAR_COLOR = ClearColor(0.02f, 0.05f, 0.18f)
        private val MESH_OR_BUFFER_ERROR_CLEAR_COLOR = ClearColor(0.18f, 0.02f, 0.18f)

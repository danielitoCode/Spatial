...
// Single gradlePlugin block — Gradle only allows one per project.
gradlePlugin {
    ...
    plugins {
        ...
        register("spatialAndroidLibrary") {
            ...
            description = "Convention plugin for Spatial Android library modules"
        }
        ...
        register("spatialAndroidApplication") {
            ...
            description = "Convention plugin for Spatial Android application modules"
        }
        ...
        register("spatialAndroidLibraryCompose") {
            ...
            description = "Enables Jetpack Compose for Spatial Android library modules"
        }
